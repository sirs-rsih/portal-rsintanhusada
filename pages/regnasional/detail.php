<?php
    ...
    include('../../config.php');
    $unit = $_GET['unit'];
    $_SESSION['menu']='REGULASI NASIONAL';
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-lg-12">
                            ...
                            ?>
                                    <div class="alert alert-success" role="alert">
                                        <strong>Berhasil!</strong> <?php echo($unit); ?> baru berhasil di input
                                    </div>
                            <?php
                                }else if (!empty($_GET['message']) && $_GET['message'] == 'updated') {
                            ?>
                                    <div class="alert alert-success" role="alert">
                                        <strong>Berhasil!</strong> <?php echo($unit); ?> berhasil di Update
                                    </div>
                            <?php
                                }
                            ?>
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="panel panel-default">
                                    <div class="panel-heading"> DETAIL <?php echo($_SESSION['menu'].' '.$unit); ?>
                                        <?php
                                            $id = $_GET['id'];
                                            $tampil = mysqli_query($connect,"SELECT * FROM regnasional WHERE id='$id'");
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                ...
                                                <h4 class="mb-1">JUDUL <?php echo($_SESSION['menu'].' '.$unit); ?></h4>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                <div class="d-flex w-100 justify-content-between">
                                                <h4 class="mb-1">DESKRIPSI <?php echo($_SESSION['menu'].' '.$unit); ?></h4>
                                                <!-- <small>3 days ago</small> -->
                                                </div>
                            ...
                            <div class="col-lg-7">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <a disabled href="../controller/deletefileregnasional.php?unit=<?php echo($unit);?>&files=<?php echo($w['files']);?>&id=<?php echo($id);?>" onclick="return  confirm('Apakah anda yakin ingin menghapus file ini?')" class="btn btn-sm btn-default"><i class="fa fa-trash"></i> HAPUS DOKUMEN</a>
