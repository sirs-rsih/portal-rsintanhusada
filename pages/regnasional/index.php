...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><?php echo($unit); 
                                                    ...
                                                    ?>
                                                                <a href="#tambah_regnasional" class="btn btn-sm btn-success pull-right" id="NotID" data-toggle="modal"><i class="fa fa-upload"></i> TAMBAH <?php echo($unit);?> BARU</a> </h1>
                                                    <?php
                                                            }
                                                    ?>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-regnasional">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
                                                <th>JUDUL</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query="SELECT * FROM regnasional ORDER BY tgl_upload ASC";
                                                //menjalankan query      
        ...
        <?php
            include('../modal/tambahregnasional.php');
        ...
        <script>
            $(document).ready(function() {
                $('#dataTables-regnasional').DataTable({
                    responsive: true
                });
            });
