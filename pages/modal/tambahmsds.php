<div class="modal fade" id="tambah_msds" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="judul">BERKAS <?php echo $unit;?> BARU</h4>
            </div>
            <div class="modal-body">
                <form action="../controller/vmsds.php?unit=<?php echo $unit;?>" method="post" enctype="multipart/form-data">
