...
<body>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-ptrsihsk">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>JUDUL</th>
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM ptrsihsk ORDER BY tgl_upload ASC";
                                        //menjalankan query      
    ...
    <?php
    // include('../modal/tambahptrsihsk.php');
