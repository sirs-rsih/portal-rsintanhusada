                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="panel panel-default">
                                    <div class="panel-heading"> DETAIL Arsip Rapat
                                        <?php
                                            $id = $_GET['id'];
                                            $tampil = mysqli_query($connect,"SELECT * FROM arsip_rapat WHERE id='$id'");
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                ...
                                                <h4 class="mb-1">JUDUL Arsip Rapat</h4>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                <div class="d-flex w-100 justify-content-between">
                                                <h4 class="mb-1">DESKRIPSI Arsip Rapat</h4>
                                                <!-- <small>3 days ago</small> -->
                                                </div>
