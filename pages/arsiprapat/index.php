...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><?php echo($_SESSION['menu'].' '.$unit);
                                                    ...
                                                    ?>
                                                                <a href="#tambah_arsip_rapat" class="btn btn-sm btn-success pull-right" id="NotID" data-toggle="modal"><i class="fa fa-upload"></i> TAMBAH Arsip <?php echo($unit);?> BARU</a> </h1>
                                                    <?php   } ?>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            ?>
                                <div class="alert alert-success" role="alert">
                                    <strong>Berhasil!</strong> Arsip Rapat <?php echo($unit); ?> baru berhasil di input
                                </div>
                            <?php 
                                }else if (!empty($_GET['message']) && $_GET['message'] == 'deleted') {
                            ?>
                                <div class="alert alert-success" role="alert">
                                    <strong>Berhasil!</strong> Arsip Rapat <?php echo($unit); ?> baru berhasil di hapus
                                </div>
                            <?php
                                }else if (!empty($_GET['message']) && $_GET['message'] == 'updated') {
                            ?>
                                <div class="alert alert-success" role="alert">
                                    <strong>Berhasil!</strong> Arsip Rapat <?php echo($unit); ?> berhasil di Update
                                </div>
                            <?php
                                }else if (!empty($_GET['error']) && $_GET['error'] == '1') {
                            ?>
                                <div class="alert alert-danger" role="alert">
                                    <strong>Kesalahan!</strong> Ukuran File Arsip Rapat<?php echo($unit); ?> lebih dari 5MB, silahkan compress terlebih dahulu.
                                </div>
                            <?php
                                }else if (!empty($_GET['error']) && $_GET['error'] == '2') {
                            ?>
                                <div class="alert alert-danger" role="alert">
                                    <strong>Kesalahan!</strong> Pastikan File Arsip Rapat <?php echo($unit); ?> ber ekstensi PDF.
                                </div>
                            <?php
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Daftar Arsip Rapat <?php echo($unit.' '.$company); ?>
                                </div>
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-spo">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query="SELECT * FROM arsip_rapat WHERE unit = '$unit' ORDER BY tgl_upload ASC";
                                                //menjalankan query      
                                            ...
                                            <?php
                                                        echo "  <td width='20%' align='center'> <a href='detail.php?unit=$unit&id=$row[id]' class='btn btn-sm btn-primary'> <i class='glyphicon glyphicon-list-alt'></i> LIHAT DETAIL DATA</a>";
                                                        if(($_SESSION['level']==='0') OR ($_SESSION['level']==='1')){
                                            ?>
        ...
        <?php
            include('../modal/tambaharsiprapat.php');
