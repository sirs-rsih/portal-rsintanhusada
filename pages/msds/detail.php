                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="panel panel-default">
                                    <div class="panel-heading"> DETAIL MSDS
                                        <?php
                                            $id = $_GET['id'];
                                            $tampil = mysqli_query($connect,"SELECT * FROM msds WHERE id='$id'");
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                <div class="d-flex w-100 justify-content-between">
                                                <h4 class="mb-1">DESKRIPSI MSDS</h4>
                                                <!-- <small>3 days ago</small> -->
                                                </div>
                            ...
                            <div class="col-lg-7">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <a disabled href="../controller/deletefilemsds.php?unit=<?php echo($unit);?>&files=<?php echo($w['files']);?>&id=<?php echo($id);?>" onclick="return  confirm('Apakah anda yakin ingin menghapus file ini?')" class="btn btn-sm btn-default"><i class="fa fa-trash"></i> HAPUS DOKUMEN</a>
