                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="panel panel-default">
                                    <div class="panel-heading"> DETAIL <?php echo ($unit); ?>
                                        <?php
                                        $id = $_GET['id'];
                                        $tampil = mysqli_query($connect, "SELECT * FROM spkdirektur WHERE id='$id'");
                                        ...
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                <div class="d-flex w-100 justify-content-between">
                                                    <h4 class="mb-1">JUDUL <?php echo ($unit); ?></h4>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                <div class="d-flex w-100 justify-content-between">
                                                    <h4 class="mb-1">DESKRIPSI <?php echo ($unit); ?></h4>
                                                    <!-- <small>3 days ago</small> -->
                                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <object
                                            ...
                                            data="viewpdf.php?file=<?php echo urlencode(basename($w['files'])); ?>"
                                            width="100%"
                                            height="650">
                                        </object>
                                    </div>
