...
<body>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-ptrsihkebijakan">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>JUDUL</th>
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM ptrsihkebijakan ORDER BY tgl_upload ASC";
                                        //menjalankan query      
    ...
    <?php
    // include('../modal/tambahptrsihkebijakan.php');
    ...
    <script>
        $(document).ready(function() {
            $('#dataTables-ptrsihkebijakan').DataTable({
                responsive: true
            });
        });
