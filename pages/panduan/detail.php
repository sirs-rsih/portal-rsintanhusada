                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="panel panel-default">
                                    <div class="panel-heading"> DETAIL PANDUAN
                                        <?php
                                            $id = $_GET['id'];
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                ...
                                                <h4 class="mb-1">JUDUL PANDUAN</h4>
                                            ...
                                            <a href="#" class="list-group-item list-group-item-action" aria-current="true">
                                                <div class="d-flex w-100 justify-content-between">
                                                <h4 class="mb-1">DESKRIPSI PANDUAN</h4>
                                                <!-- <small>3 days ago</small> -->
                                                </div>
                            ...
                            <div class="col-lg-7">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <a disabled href="../controller/deletefilepanduan.php?unit=<?php echo($unit);?>&files=<?php echo($w['files']);?>&id=<?php echo($id);?>" onclick="return  confirm('Apakah anda yakin ingin menghapus file ini?')" class="btn btn-sm btn-default"><i class="fa fa-trash"></i> HAPUS DOKUMEN</a>
                                        <!--<a href="<?php echo($w['files']);?>" class="btn btn-sm btn-default"><i class="fa fa-trash"></i> DOWNLOAD DOKUMEN</a>-->
