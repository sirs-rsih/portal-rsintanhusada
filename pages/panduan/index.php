                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><?php echo($_SESSION['menu'].' '.$unit);
                                                    ...
                                                    ?>
                                                            <a href="#tambah_panduan" class="btn btn-sm btn-success pull-right" id="NotID" data-toggle="modal"><i class="fa fa-upload"></i> TAMBAH PANDUAN <?php echo($unit);?> BARU</a> </h1>
                                                    <?php
                                                            }
                                                    ?>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            ?>
                                <div class="alert alert-success" role="alert">
                                    <strong>Berhasil!</strong> Panduan <?php echo($unit); ?> baru berhasil di input
                                </div>
                            <?php 
                                }else if (!empty($_GET['message']) && $_GET['message'] == 'deleted') {
                            ?>
                                <div class="alert alert-success" role="alert">
                                    <strong>Berhasil!</strong> SPO <?php echo($unit); ?> baru berhasil di hapus
                                </div>
                            <?php
                                }else if (!empty($_GET['message']) && $_GET['message'] == 'updated') {
                            ?>
                                <div class="alert alert-success" role="alert">
                                    <strong>Berhasil!</strong> Panduan <?php echo($unit); ?> berhasil di Update
                                </div>
                            <?php
                                }else if (!empty($_GET['error']) && $_GET['error'] == '1') {
                            ?>
                                <div class="alert alert-danger" role="alert">
                                    <strong>Kesalahan!</strong> Ukuran File Panduan <?php echo($unit); ?> lebih dari 5MB, silahkan compress terlebih dahulu.
                                </div>
                            <?php
                                }else if (!empty($_GET['error']) && $_GET['error'] == '2') {
                            ?>
                                <div class="alert alert-danger" role="alert">
                                    <strong>Kesalahan!</strong> Pastikan File Panduan <?php echo($unit); ?> ber ekstensi PDF.
                                </div>
                            <?php
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-panduan">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query="SELECT * FROM panduan WHERE unit = '$unit' ORDER BY tgl_upload ASC";
                                                //menjalankan query      
