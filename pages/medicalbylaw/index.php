                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-mbl">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>JUDUL</th>
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM medicalbylaw WHERE unit = '$unit' ORDER BY tgl_upload ASC";
                                        //menjalankan query      
