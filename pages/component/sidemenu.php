<div class="navbar-default sidebar" role="navigation">
  <div class="sidebar-nav navbar-collapse">
    <ul class="nav" id="side-menu">
      ...
      <li>
        <a href="../regnasional/"><i class="fa fa-building fa-fw"></i> Regulasi Nasional</a>
      </li>
      ...
      <li>
        <a href="../tarif/" title="Tarif yang berlaku di RSIH"><i class="fa fa-dollar fa-fw"></i> Tarif</a>
      </li>
      <li>
        <a href="../meetingroom/" title="booking ruangan belajar, PT, Diskusi 1 & 2"><i class="fa fa-book fa-fw"></i> Booking Meeting Room</a>
      </li>
...
";
      ...
      <li>
        ...
        <ul class="nav nav-second-level">
          ...
          // session_start();
          include('../../config.php');
          $query = "SELECT * FROM mst_unit WHERE (manajer = 1 OR manajer = 2) AND id <> 39";
      ...
      <li>
        ...
        <ul class="nav nav-second-level">
          <li>
            <a href="#">Arsip Rapat <span class="fa arrow"></span></a>
            <ul class="nav nav-third-level">
              <?php
              // session_start();
              include('../../config.php');
              $query = "SELECT * FROM mst_arsip_rapat";
              if (mysqli_query($connect, $query)) {
                $result = mysqli_query($connect, $query);
              } else die("Error menjalankan query");
              //mengecek record kosong     
              ...
              ?>
                <li>
                  <a href="../arsiprapat/index.php?unit=<?php echo ($row['nama']); ?>"> <?php echo ($row['nama']); ?></a>
                </li>

              <?php } ?>
              <li>
                <a href="#">Rapat Internal Divisi/Unit/Komite <span class="fa arrow"></span></a>
                <ul class="nav nav-fourth-level">
                  <?php
                  // session_start();
                  include('../../config.php');
                  $query = "SELECT * FROM mst_arsip_rapat_divisi";
                  if (mysqli_query($connect, $query)) {
                    $result = mysqli_query($connect, $query);
                  } else die("Error menjalankan query");
                  //mengecek record kosong     
                  ...
                  ?>
                    <li>
                      <a style="margin-left: 10px" href="../arsiprapat/index.php?unit=<?php echo ($row['nama']); ?>"> <?php echo ($row['nama']); ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </li>
      ...
      <li>
        <a href="../msds/" title="Test Hint"><i class="fa fa-flask fa-fw"></i> MSDS</a>
      </li>
    </ul>
  </div>
  ...
  <div class="navbar-brand">
    ...
    <small> <a href="https://www.instagram.com/w.auliaabdillah" target="_blank"><i class="fa fa-instagram" aria-hidden="true"> </i> Wildan Auliana</a></small>
  </div>
</div>