...
$unit            = 'PERATURAN DIRUT TENTANG SOTK';
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-hospital-o fa-fw"></i> <?php echo ($_SESSION['menu'] . ' ' . $unit);
                                                                                        ...
                                                                                        ?>
                                <a href="#tambah_dokumen" class="btn btn-sm btn-success pull-right" id="NotID" data-toggle="modal"><i class="fa fa-upload"></i> TAMBAH BERKAS <?php echo ($unit); ?> BARU</a>
                        </h1>
                    <?php   } ?>
                    </div>
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-sotk">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>JUDUL</th>
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM aturandirutsotk WHERE unit = '$unit' ORDER BY tgl_upload ASC";
                                        //menjalankan query      
